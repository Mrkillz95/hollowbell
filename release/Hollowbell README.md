# Hollowbell (Java mod) — version 1.1.0
...
2. Put `hollowbell-1.1.0.jar` in `.minecraft\mods`. Take the 1.0.0 jar out first. It sits fine next to Pitchgut and Furrowmaw.
...
| 1 to 0, then Z X C V B N M, then R H J K U | his 22 moves, light ones first (the list sits down the left of the screen with a clock on each line) |
